...
public class UnityCollision : MonoBehaviour
{
    ...
    // <유니티 충돌 메시지>
    private void OnCollisionEnter(Collision collision)      // 충돌에 진입(충돌 시작)했을 때
    {
        Debug.Log("OnCollisionEnter");
    }

    private void OnCollisionStay(Collision collision)       // 계속 충돌되고 있을 때
    {
	 ...
	 * 
	 * 일반 충돌체와 다르게 서로 밀어내지 않고 통과하게 됨
	 ************************************************************************/

    // <유니티 트리거 메시지>
    private void OnTriggerEnter(Collider other)             // 겹쳐졌을 때
    {
        Debug.Log("OnTriggerEnter");
    }

    private void OnTriggerStay(Collider other)              // 겹쳐져 있는 중일 때
    {
        Debug.Log("OnTriggerStay");
    }

    private void OnTriggerExit(Collider other)              // 겹침이 종료됬을 때
    {
